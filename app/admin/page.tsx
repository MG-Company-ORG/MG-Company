          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            >
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  <h3 className="text-lg font-medium text-gray-900">배너 관리</h3>
                  <p className="text-sm text-gray-500">사이트 광고 배너 관리</p>
                </div>
              </div>
            </Link>
            ...
            <div className="bg-white rounded-lg shadow-sm border p-6">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-sm text-gray-500">시스템 설정 (구현 예정)</p>
                </div>
              </div>
            </div>
          </div>
